...
(function($) {
    ...
    var emRegex = "/::\\)|/::~|/::B|/::\\||/:8-\\)|/::lt|/::\\$|/::X|/::Z|/::'\\(|/::-\\||/::@|/::P|/::D|/::O|/::\\(|/::\\+|/:--b|/::Q|/::T|/:,@P|/:,@-D|/::d|/:,@o|/::g|/:\\|-\\)|/::!|/::L|/::gt|/::,@|/:,@f|/::-S|/:\\?|/:,@x|/:,@@|/::8|/:,@!|/:!!!|/:xx|/:bye|/:wipe|/:dig|/:handclap|/:and-\\(|/:B-\\)|/:lt@|/:@gt|/::-O|/:gt-\\||/:P-\\(|/::'\\||/:X-\\)|/::\\*|/:@x|/:8\\*|/:pd|/:ltWgt|/:beer|/:basketb|/:oo|/:coffee|/:eat|/:pig|/:rose|/:fade|/:showlove|/:heart|/:break|/:cake|/:li|/:bome|/:kn|/:footb|/:ladybug|/:shit|/:moon|/:sun|/:gift|/:hug|/:strong|/:weak|/:share|/:v|/:@\\)|/:jj|/:@@|/:bad|/:lvu|/:no|/:ok"
    ...
    var getEmByName = _.memoize(function(name) {
        var emCode;
        for (key in em) {
    ...
    $.fn.extend({
        jqfaceedit: function(options) {
            ...
            var removeFace = function() {
                options.containerObj.find('#face').closest(".dropdown").removeClass("open").end().remove();
            }
            return this.each(function() {
                ...
                $(Obj).bind("click", function(e) {
                    ...
                    for (key in ems) {
                        ...
                        faceHtml += '<li text="[' + title + ']"><img title="' + title + '" src="/emotions/' + name + '.png"  style="cursor:pointer; position:relative;"   /></li>';
                    }
                    faceHtml += '</ul></div>';
                    ...
                    //处理js事件冒泡问题
                    $('body').bind("click.emoticon", function(eb) {
                        if (!$(eb.target).closest(".action-addface").length) {
    ...
    $.extend({
        emotionsToHtml: function(orignalText) {
            ...
            return orignalText.replace(regx, function(match) {
                ...
                return "<img class='emotion' title='" + title + "' src='/emotions/" + name + ".png' />";
            })
        },
