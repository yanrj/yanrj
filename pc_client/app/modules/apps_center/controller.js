...
angular.module('mxWebClientApp')
  .controller('AppCentreCtrl', ['$scope', 'CheckToken', '$route', 'CurUserDB', 'Storage', 'RTC','AppRootBinder', '$compile','SidebarNavBinder', 'Cache',
    function ($scope, CheckToken, $route, CurUserDB, Storage, RTC, AppRootBinder, $compile, SidebarNavBinder, Cache) {
        ...
        Cache.put('rootDir', nw.App.dataPath+'/');
    }
  ]);