'use strict';
angular.module('mx.treecontacts.company', [])
/*
 * 公司通讯录按钮
 */
.directive('companyTreeContactsBtn', ['DepartmentsLoader', '$rootScope', 'CompanyCrumbs', 'ContactsStatus', 'ContactBinder','GLOBAL_SETTING',
 ...
 * 公司通讯录容器
 */
.directive('companyTreeContacts', ['RootscopeApply', 'ContactBinder', 'ContactsDeptServ', 'PopMessage', '$route', 'FriendsListServ', '$rootScope', 'CompanyListBinder', 'GLOBAL_SETTING', '$injector',
	function(RootscopeApply, ContactBinder, ContactsDeptServ, PopMessage, $route, FriendsListServ, $rootScope, CompanyListBinder, GLOBAL_SETTING, $injector) {
		return {
			restrict: 'EA',
			template: '<company-tree-contact-item ng-repeat="item in items"></company-tree-contact-item>\
 ...
 * 公司通讯录列表(群聊成员选择器中使用)
 */
.directive('companyTreeList', ['RootscopeApply', 'CompanyListBinder', '$injector','Cache', 'CompanySelectedAllBinder',
	function(RootscopeApply, CompanyListBinder, $injector, Cache, CompanySelectedAllBinder) {
		return {
			restrict: 'EA',
			template: '<div class="selected-all" selected-all-company ng-show="companys.length > 0">\
						...
						<company-tree-contact-item ng-repeat="item in companys"></company-tree-contact-item>\
 ...
 * 公司通讯录item元素
 */
.directive('companyTreeContactItem', ['$compile', 'DepartmentDeepIn', 'RootscopeApply', 'ContactBinder', 'GroupMemberSelect', 'Storage', 'PopMessage', 'DepartmentsLoader', '$location', '$rootScope', 'CompanyListBinder', 'CompanySelectedAllBinder',
	function($compile, DepartmentDeepIn, RootscopeApply, ContactBinder, GroupMemberSelect, Storage, PopMessage, DepartmentsLoader, $location, $rootScope, CompanyListBinder, CompanySelectedAllBinder) {
		return {
			restrict: 'EA',
			template: '<div btn-user data-type="{{popupType}}" class="item {{type}}" ng-class="{\'no-head\':uHead == null,\'selected\':selected == true}" title="{{name}}" data-id="{{id}}">\
...
//公司通讯录的面包屑记录服务
.factory('CompanyCrumbs', ['Crumbs', '$rootScope', 'ContactsStatus', function(Crumbs, $rootScope, ContactsStatus) {
