'use strict';
angular.module('mx.contacts.ocus')
    /*
     * 公众号按钮
     */
     ...
     * 公众号容器
     */
    .directive('servicesContacts', ['RootscopeApply', 'Crumbs', 'ContactBinder', function(RootscopeApply, Crumbs, ContactBinder) {
        return {
            restrict: 'EA',
 ...
 * 添加公众号按钮
 */
.directive('ocuAddBtn', ['$rootScope', 'OcusLoader', 'Crumbs', 'ContactBinder',
     ...
     * 应用中心item元素
     */
    .directive('ocuBtns', ['$rootScope', 'OcuBtnsBinder', '$injector', 'RootscopeApply', 'Cache',
...
.directive('ocuMenu', ['RootscopeApply',
     ...
     * 公众号菜单按钮
     */
    .directive('ocuBtn', ['OcuMenuServ', 'GLOBAL_SETTING', 'PublisherBinder', 'Storage',
     ...
     * 公众号item元素
     */
    .directive('ocuContactItem', ['OcusLoader', '$rootScope', 'Crumbs', 'ContactsStatus', 'ConversationBinder','ConversationAboutOcu','Cache',
     ...
     * 公众号信息
     */
    .directive('ocuInfo', ['GLOBAL_SETTING', 'OcusLoader', '$rootScope', 'ConversationListBinder',
