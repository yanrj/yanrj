'use strict';
angular.module('mx.contacts.friends', [])

.directive('friendsList', ['RootscopeApply',
	function(RootscopeApply) {
		return {
			restrict: 'A',
			transclude:true,
			template: 	'<div ng-transclude></div>\
						<div contact-item ng-repeat="item in friendsList | orderBy:\'pinyin\'" ></div>\
...
.directive('contactItem', ['GroupMemberSelect', 'RootscopeApply', '$location', '$rootScope',
